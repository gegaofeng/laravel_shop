	...
	<div class="flexigrid">
		<div class="mDiv">
			<div class="ftitle">
                ...
                <div class="fbutton">
                    <a href="http://help.tp-shop.cn/Index/Help/info/cat_id/5/id/48.html" target="_blank">
				...
				<table>
					...
					<foreach name="list" item="vo" key="k" >
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 80px;">{$vo.rebate}</div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									<a class="btn blue" target="_blank" href="{:U('Home/Goods/goodsInfo',array('id'=>$vo[goods_id],'item_id'=>$vo[item_id]))}"><i class="fa fa-search"></i>查看</a>
