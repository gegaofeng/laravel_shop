...
<link rel="icon" href="/static/animated_favicon.gif" type="image/gif" />
...
<body>
	<div class="login-layout">
    	<div class="logo">
            <img src="/static/images/logo/admin_login_logo_default.png">
        </div>
        <form action="" name='theForm' id="theForm" method="post">
            <div class="login-form" style="position: relative">
                <div class="formContent">
                    <div class="title"><a href="{{url('admin/home')}}">管理中心</a>    </div>
                    <div class="formInfo">
                    	<div class="formText">
                        ...
                        <div class="formText">
                            ...
                            <img src="/index.php/admin/Admin/vertify" class="chicuele" id="imgVerify" alt="" onclick="fleshVerify()">
                        </div>
                        <div class="formText">
                        	<!--<div class="checkbox">
                            	<div class="cur">
    ...
    <div id="bannerBox">
        <ul id="slideBanner" class="slideBanner">
            <li><img src="/static/images/banner_1.jpg"></li>
            <li><img src="/static/images/banner_2.jpg"></li> 
            <li><img src="/static/images/banner_3.jpg"></li>
        </ul>
    </div>
