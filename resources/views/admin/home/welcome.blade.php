            ...
            <div class="contentWarp_item clearfix">
                <div class="section_select">
                    <div class="item item_price">
                        <i class="icon"><img src="/static/images/1.png" width="71" height="74"></i>
                        <div class="desc">
                            <div class="tit">0</div>
                            <span>今日订单总数</span>
                        </div>
                    ...
                    <div class="item item_order">
                        <i class="icon"><img src="/static/images/2.png"></i>
                        <div class="desc">
                            <div class="tit">0</div>
                            <span>今日会员总数</span>
                        </div>
                    ...
                    <div class="item item_comment">
                        <i class="icon"><img src="/static/images/3.png" width="90" height="86"></i>
                        <div class="desc">
                            <div class="tit">0</div>
                            <span>今日待审评论数</span>
                        </div>
                    ...
                    <div class="item item_flow">
                        <i class="icon"><img src="/static/images/4.png" width="86"></i>
                        <div class="desc">
                            <div class="tit">0</div>
                            <span>今日访问量</span>
                        </div>
                    ...
                    <div class="sc_warp" id="system_warp" style="display: block;padding-bottom: 30px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            <tbody><tr>
                                ...
                                <td>127.0.0.8:8080 [ 127.0.0.8 ]</td>
                            </tr>
                            <tr>
                                <td class="gray_bg">服务器环境:</td>
                                <td>Apache/2.4.25 (Win32) OpenSSL/1.0.2j PHP/5.6.30</td>
