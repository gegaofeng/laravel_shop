...
<div class="page">
    ...
    <div id="explanation" class="explanation" style=" width: 99%; height: 100%;">
        ...
        <ul>
            <li>查看操作可以查看拼团成员, 包括拼团成员订单信息等</li>
        </ul>
    </div>
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" method="get" action="{:U('Team/team_order')}" target="_self">
                <div class="sDiv">
                    <div class="sDiv2">
                        <input type="text" size="30" name="team_id" value="{$Request.param.team_id}" class="qsbox"  placeholder="拼团ID">
                    </div>
                    <div class="sDiv2">
                        <input type="text" size="30" id="start_time" name="start_time" value="{$start_time}" class="qsbox"  placeholder="开团开始时间">
                    </div>
                    <div class="sDiv2">
                        <input type="text" size="30" id="end_time" name="end_time" value="{$end_time}" class="qsbox"  placeholder="开团开始时间">
                    </div>
                    <div class="sDiv2">
