				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="center" abbr="ac_id" axis="col4" class="">
							<div style="text-align: left; width: 100px;" class="">自提点名称</div>
						</th>
						...
						<th align="center" abbr="article_time" axis="col6" class="">
							<div style="text-align: center; width: 190px;" class="">自提点地址</div>
						</th>
						<th align="center" abbr="article_time" axis="col6" class="">
						...
						<th align="center" abbr="article_time" axis="col6" class="">
							<div style="text-align: center; width: 230px;" class="">营业时间</div>
						</th>
				...
				<table>
					...
					<volist name="list" id="shop">
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 100px;">{$shop['area_list'][0]['name']}</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 100px;">{$shop['area_list'][1]['name']}</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 100px;">{$shop['area_list'][2]['name']}</div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="">
								<div style="text-align: center; width: 100px;">{$shop['suppliers']['suppliers_name']|default='--'}</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 240px;line-height: 15px;">{$shop['work_day']}<br/>{$shop['work_start_time']} - {$shop['work_end_time']}</div>
							</td>
