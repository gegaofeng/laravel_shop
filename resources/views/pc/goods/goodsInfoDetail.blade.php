                        ...
                        <ul id="fy-comment-list">
                            <li data-t="1" class="red">
                                <a href="javascript:void(0);"
                                   class="selected">全部评论（{$commentStatistics['c0']}）</a>
                            </li>
                            <li data-t="2">
