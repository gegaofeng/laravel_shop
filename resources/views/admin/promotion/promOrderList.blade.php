...
<div class="page">
	...
	<div class="flexigrid">
		...
		<div class="tDiv">
			<div class="tDiv2">
				<a href="{:U('Promotion/prom_order_info')}">
					<div class="fbutton">
				...
				<table>
					...
					<foreach name="prom_list" item="vo" key="k" >
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 240px;">{$vo.name|getSubstr=0,30}</div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 80px;">{$parse_type[$vo[type]]}</div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a class="btn blue" href="{:U('Promotion/prom_order_info',array('id'=>$vo['id']))}"><i class="fa fa-pencil-square-o"></i>编辑</a>
									<a class="btn red" onclick="delfun(this)" data-id="{$vo['id']}"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
