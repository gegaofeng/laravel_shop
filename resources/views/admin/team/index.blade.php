							...
							<td align="left" class="">
								<div style="text-align: center; width: 80px;">
									<if condition='$team[status] eq 1'>
										<span class="yes" onClick="changeTableVal('team_activity','team_id','{$team.team_id}','status',this,'是','否')" ><i class="fa fa-check-circle"></i>是</span>
										<else />
										<span class="no" onClick="changeTableVal('team_activity','team_id','{$team.team_id}','status',this,'是','否')" ><i class="fa fa-ban"></i>否</span>
									</if>
								</div>
							</td>
