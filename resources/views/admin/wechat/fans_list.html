                ...
                <volist name="user_list" id="list">
                    <tr data-id="{$list.openid}">
                        ...
                        <td align="center" axis="col0">
                            <div style="width: 60px;"><img src="{$list.weixin.headimgurl}" width="30" height="30"></div>
                        </td>
                        <td align="center" axis="col0">
                            <div style="text-align: center; width: 250px;">{$list.openid}</div>
                        </td>
                        <td align="center" axis="col0">
                            <div style="text-align: center; width: 100px;">{$list.weixin.nickname}</div>
                        </td>
                        <td align="center" axis="col0">
                            <div style="text-align: center; width: 50px;">{$list.weixin.sex_name}</div>
                        </td>
                        <td align="center" axis="col0">
                            <div style="text-align: center; width: 150px;">{$list.weixin.country} -
                                {$list.weixin.province} - {$list.weixin.city}
                            </div>
                        </td>
                        <td align="center" axis="col0">
                            <div style="text-align: center; width: 50px;">{$list.weixin.language}</div>
                        </td>
                        <td align="center" axis="col0">
                            <div style="text-align: center; width: 150px;">
                                {$list.weixin.subscribe_time ? date('Y-m-d H:i:s',$list.weixin.subscribe_time) : '无'}
                            </div>
                        </td>
                        <td align="center" class="handle">
                            <div style="text-align: center; width: 150px; max-width: 150px">
                                <a href="{:U('admin/user/detail',array('id'=>$list['user_id']))}" target="_blank"
                                   class="btn blue"><i class="fa fa-user"></i>会员</a>
