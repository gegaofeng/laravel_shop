@section('personal_style')
    <link rel="stylesheet" type="text/css" href="{{asset('css/pc/myaccount.css')}}">
    <script src="{{asset('js/public/layer/layer.js')}}" type="text/javascript"></script>
    @endsection
                ...
                <div class="layel3">
                    <div class="contactsty">
                        ...
                        <div class="register_c">
                            <a class="justclix" href="/index.php/Home/User/reg.html">
