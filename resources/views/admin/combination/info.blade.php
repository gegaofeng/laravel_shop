                        ...
                        <table cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <th abbr="article_time" axis="col6" class="" align="center">
                                    <div style="text-align: center; width: 100px;" class="">规格</div>
                                </th>
                                <th abbr="article_time" axis="col6" class="" align="center">
                        ...
                        <table>
                            ...
                            <volist name="combination['combination_goods']" id="combination_goods">
                                <tr>
                                    ...
                                    <td align="left"> <div style="text-align: left; width: 100px;">{$combination_goods['goods_id']}</div> </td>
                                    ...
                                    <td align="left"> <div style="text-align: center; width: 100px;">1</div> </td>
                                    <td align="left">
                                        <div style="text-align: center; width: 100px;">
                                            <empty name="combination_goods['spec_goods_price']">
                ...
                if (item.spec != null) {
                    ...
                    $.each(item.spec, function (i, o) {
                        ...
                        html += '<tr>' +
                                ...
                                '<td align="left"> <div style="text-align: left; width: 100px;">' + item.goods_id + '</div> </td> ' +
                                ...
                                '<td align="left"> <div style="text-align: center; width: 100px;">'+ o.key_name +'</div> </td> ' +
                                '<td align="left"> <div style="text-align: center; width: 100px;">1</div> </td> ' +
                                '<td align="left"> <div style="text-align: center; width: 100px;">'+o.store_count+'</div> </td> ' +
                    ...
                    html += '<tr>' +
                            ...
                            '<td align="left"> <div style="text-align: center; width: 100px;">1</div> </td> ' +
                            '<td align="left"> <div style="text-align: center; width: 100px;">'+item.store_count+'</div> </td> ' +
