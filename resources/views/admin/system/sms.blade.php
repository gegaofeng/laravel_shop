            ...
            <dl class="row" style="display:none">
                ...
                <dd class="opt">
                    <select name="sms_platform" id="sms_platform">
                        <option value="0" <if condition="$config[sms_platform] eq 0">selected="selected"</if>>阿里大于</option>
                        <option value="1" <if condition="$config[sms_platform] eq 1">selected="selected"</if>>阿里云</option>
                        <option value="2" <if condition="$config[sms_platform] eq 2">selected="selected"</if>>短信</option>
                    </select>
