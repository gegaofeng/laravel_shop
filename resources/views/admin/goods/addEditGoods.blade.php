    ...
    <div class="page">
        ...
        <form method="post" id="addEditGoodsForm">
            ...
            <dl class="row goods_shipping">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label id="is_free_shipping_label_1" for="is_free_shipping1" class="cb-enable 
            ...
            <dl class="row">
                ...
                <dd class="opt">                
                @if($goods['goods_id']>0)
                    <input type="text" value="{{$goods['store_count']}}" class="t_mane" name="store_count" onKeyUp="this.value = this.value.replace(/[^\d.]/g, '')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                @else
                    <input type="text" value="{$tpshop_config[basic_default_storage]}" class="t_mane" name="store_count" onKeyUp="this.value = this.value.replace(/[^\d.]/g, '')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                @endif
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    @else
                    <div class="onoff">
                        <label for="is_virtual1" class="cb-enable 
                               @if($goods['is_virtual']==1)
                               selected
                               @endif
                               ">是</label>
                        <label for="is_virtual0" class="cb-disable 
            ...
            <dl class="row virtual" style="display: none;">
                ...
                <dd class="opt virtual">
                    <input id="virtual_indate" name="virtual_indate" value="{{$goods['virtual_indate']}}" class="input-txt" type="text">
